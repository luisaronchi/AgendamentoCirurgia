...
class DoctorDAO: NSObject {
    ...
    class func logOut() {
            ...
            query.findObjectsInBackgroundWithBlock {
                ...
                if error == nil {
                    if (objects?.count > 0){
                        ...
                        var doctor: Doctor = Doctor (fullname: String(), crm: Int(), cpf: Int(), speciality: String(), email: String(), officeTelephone: Int(), emergencyTelephone: Int(), password: String())
                        callback(doctor)
        ...
        class func addUser(fullName: String, withPassword password: String, withEmail email: String, callback: (error: Bool, desc: String) -> Void) -> Void {
